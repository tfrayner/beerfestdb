...
package BeerFestDB::Web::Controller::OpenIDConnect;
...
This package is a simple subclass of Catalyst::Plugin::OpenIDConnect::Controller::Root, 
included here to allow the OpenID Connect plugin to be used without needing to add it 
