...
Script used to update cask cellar ID, stillage location, bay number
and position once stillaging is complete. The script takes as input a
CSV file; see below for further details on the file format.
