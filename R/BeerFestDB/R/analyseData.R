...
analyseData <- function(cp) {
  ...
  levels(cp$abv_class) <- gsub("\\(|\\]", "", 
                               gsub(",", " - ", levels(cp$abv_class)))
  ...
  plotToFile("sale_profile_by_style.pdf", plotModelCoeffs, cp, "style",
             drop = drop, w = w)
  plotToFile("sale_profile_by_abv_class.pdf", plotModelCoeffs, cp, "abv_class",
             drop = drop, w = w)
  plotToFile("sale_profile_by_region.pdf", plotModelCoeffs, cp, "region",
             drop = drop, w = w)
  plotToFile("sale_profile_by_stillage.pdf", plotModelCoeffs, cp, "stillage",
             drop = drop, w = w)
